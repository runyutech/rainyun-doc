...
接着**选择机型和配置**，MCSM面板目前有13900KF、5900X、Gold 6146和E5 2666V3这4种配置，开1.20.2之类的高版本服建议选5900X和13900KF，不过目前没货，我这里用Gold 6146演示，**配置建议4核8G及以上**，然后**面板账号那设置一个账号**，选好后就可以**点右下角的购买**了，可以月付、年付，年付有7折优惠。
