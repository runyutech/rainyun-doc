...
雨云对象存储都是兼容s3协议的，可以[直接参考](https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javascriptv3/example_code/s3/scenarios/presigned-url-upload.js)进行操作，或者可以参考我们给出的代码实例哦。
